...
const index = () => {
  ...
  const searchMovieDecade = async () =>{
    const request = await fetch (`https://api.themoviedb.org/3/discover/movie?api_key=${api_key}&with_genres=878&primary_release_date.gte=1980-01-01&primary_release_date.lte=1989-12-31&sort_by=release_date.asc&page=${currentPage}`)
