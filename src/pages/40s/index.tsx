...
const defaultEndPoint = `https://api.themoviedb.org/3/discover/movie?api_key=b7e763dc89359ad28e83964b5a12b539&with_genres=878&primary_release_date.gte=1940-01-01&primary_release_date.lte=1949-12-31&with_keywords=space&sort_by=release_date.asc`;
      ...
      <div sx={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap'}}>
        { movies ? (movies.map((movie) => (
          <div key={movie.id} sx={{width: '33%', p: 2}}>
            <Link key={movie.id} href="/40s/[id]" as={`/40s/${movie.id}`} sx={{textDecoration: 'none', cursor: 'pointer'}}>
